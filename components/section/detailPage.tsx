...
interface DetailPageProps {
  ...
  expandedImageRef: React.RefObject<HTMLImageElement>;
  offset: MotionValue<number>;
  controls: AnimationControls;
}

export const DetailPage = React.memo<DetailPageProps>(
  ({
    sliderData,
    detailPageName,
    closeDetailPage,
    ...
    return (
      <motion.div
        style={{
          backgroundImage: "url('/projectbackground-min-darken.jpg')",
      ...
      >
        <div className="noise w-full h-full"></div>
        {/* Closing button */}
        <motion.div
          ...
          {detailPageName && (
            ...
            >
              ...
              <Image
                ...
                height={1000}
                draggable={false}
                className={`absolute z-50 top-0 left-0 h-full object-cover`}
                style={{
                  objectPosition: `${
